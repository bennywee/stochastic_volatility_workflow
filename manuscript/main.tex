...
\section{Results}
    ...
    % that we cannot directly compare the effect of the reparameterisation on the ESS between Figure \ref{fig:kscess} and Figure \ref{fig:hmcess} due to the difference in post burn-in posterior draws.
