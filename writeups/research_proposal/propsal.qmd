...
## Research Goal
The objective of this research is to validate and compare the comutational methods used to estimate Bayesian Stochastic Volatiity models. Specifically, Simulation Based Calibration will be used to identify bias and errors arising from the results of computational algorithms. The source of such errors include, but are not limited to, different estimation strategies, problems with the sampler, problematic model specifications and coding mistakes. This study will compare the estimation strategies detailed in the Stochastic Volatility literature and the application of Hamiltonina Monte Carlo for estimating these class of models. Results and diagnostics from these simulations will help identify strengths and limitations that arise from these approaches and provide tools for evaluating other types models and algorithms. 
